    ...
    <form class="form-inline row text-center">
        <a class="col-2 px-1" href="home.php">
            <button class="btn btn-outline-success" type="button">
                <svg width="1.5em" height="2em" viewBox="0 0 16 16" class="bi bi-house-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="col-2 px-1" href="contact.php">
            <button class="btn btn-outline-primary" type="button">
                <svg width="1.5em" height="2em" viewBox="0 0 16 16" class="bi bi-person-lines-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="col-2 px-1" href="bets.php">
            <button class="btn btn-outline-info" type="button">
                <svg width="1.5em" height="2em" viewBox="0 0 16 16" class="bi bi-suit-club" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
